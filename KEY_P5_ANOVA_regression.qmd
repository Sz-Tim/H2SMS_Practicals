...
ggplot(algae_df, aes(Treatment)) + 
  geom_point(aes(Yield), shape=1) +
  geom_errorbar(data=algae_emm, aes(ymin=lower.CL, ymax=upper.CL), colour="red") +
  geom_point(data=algae_emm, aes(emmean), shape=1, size=2, colour="red")
```
