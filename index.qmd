...
The practicals are provided [online](https://sz-tim.quarto.pub/h2ds-practicals/) and as a pdf on Brightspace. The web version has additional features that are not possible with pdfs and is the recommended interface. The underlying files (lightly edited) are available on Brightspace.
