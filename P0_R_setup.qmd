...
4.  Set the *Directory name* as **H2SMS** and use the *Browse* button by *Create project as a subdirectory of:* to set a convenient location in your OneDrive folder. Click 'Create Project'.
...
7.  Close RStudio (to learn how to open appropriately)
...
::: callout-caution
I repeat: **Open H2SMS.Rproj** instead of the .R or .qmd file you plan to work on!

Opening the .R or .qmd from Windows Explorer will *not* set your R working directory correctly!
:::

This is the start-up process you should use for the practicals:

1.  Open Windows Explorer (or Finder on Mac) and find your **H2SMS** folder.
2.  Double click on **H2SMS.Rproj**. This opens your R project with the working directory set to that folder. The working directory is shown at the top of the Console pane, and you can check it with `getwd()`. This is where R is 'situated' when loading or saving files.
3.  Create a new .R file for that week's practical.

To create a new .R file, click *New Blank File* at the top of the **Files** panel and selecting *R Script*. Name it *Practical_1.R* or similar.

![H2SMS directory structure.](figs/RStudio_projectFiles.png){#fig-RStudioDirectoryStructure}
